                    ...
                    try {
                        ...
                        await page.evaluate(() => {
                            ...
                            const elementsToRemove = document.querySelectorAll(
                                '.sc-45df63c3-1.hgWsmb, .sc-4df7a8a0-0.cOwLcG, .sc-4df7a8a0-0.hmYLKc, .sc-acb0869a-0.bxBBvR.sc-be2fc1e4-0.jhHupj'
                            );
                            elementsToRemove.forEach(element => element.remove());
                        });

                        const articleBodySelector = '.sc-426c7a0c-0.kFFBpt p'; // Selector for the article body
