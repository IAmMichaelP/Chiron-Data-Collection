...
(async () => {
    ...
    try {
        ...
        await page.goto('https://www.abs-cbn.com/news/nation');

        const moreButtonSelector = '.MuiButtonBase-root.MuiButton-textPrimary.css-34fiem';
        const articleSelector = '.MuiGrid-item .MuiTypography-root.MuiTypography-inherit.MuiLink-root';
        const titleSelector = '.MuiGrid-item .MuiTypography-root.MuiTypography-inherit.MuiLink-root h3';
        ...
        // Save results to CSV
        const csvPath = path.join(__dirname, "scraped_data.csv3");
