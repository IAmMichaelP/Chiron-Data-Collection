    ...
    try {
        ...
        await page.evaluate(() => {
            const selectorsToRemove = [
                ".entry-title", ".FreeStar", ".Advertisement", ".expanded-byline-contributors", ".articleBylineContainer", ".em-mod-video", ".anchortext", ".module.ad",
        ...
        const articleBodySelector = ".RichTextBody p";
        const authorSelector = ".Page-authors .Link";
        const dateSelector = ".Page-dateModified [data-date]";
        ...
        const paragraphs = await page.$$eval(articleBodySelector, (elements) => {
            ...
            for (const el of elements) {
                ...
                if (el.classList.contains("endmark") || text === "Read More" || text === "Read More:" || text == "___") break;
                content.push(text);
            }
            return content;
        });
