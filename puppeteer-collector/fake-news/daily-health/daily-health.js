...
(async () => {
    ...
    try {
        ...
        const baseUrl = 'https://dailyhealthpost.com/wellness/';
        const articleSelector = 'section.entry-wrap';
        const titleSelector = 'h2.entry-title a'; // Selector for anchor within entry-title
