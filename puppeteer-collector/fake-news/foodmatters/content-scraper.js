    ...
    try {
        ...
        await page.evaluate(() => {
            const selectorsToRemove = [
                ".entry-title", ".add-to-recipe-book", ".FreeStar", ".Advertisement", ".expanded-byline-contributors", ".articleBylineContainer", ".em-mod-video", ".anchortext", ".module.ad",
        ...
        const articleBodySelector = ".article-description p";
        const dateSelector = ".article-hero-content .date";
        ...
        const paragraphs = await page.$$eval(articleBodySelector, (elements) => {
            ...
            for (const el of elements) {
                ...
                if (parent) break; // Stop before promotional content
                const text = el.textContent.trim();
                if (text === "Read More" || text === "Read More:" || text === "___") break;
                content.push(text);
            }
            return content;
        });
