...
class CrawlingSpider(CrawlSpider):
    ...
    rules = (
        Rule(LinkExtractor(allow="lifestyle/health-wellness/"), callback="parse_item", follow={'lua_source': lua_script, 'timeout': 90, 'resource_timeout': 20}),
